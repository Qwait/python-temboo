...
class CreateFolder(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateFolder, self).__init__(temboo_session, '/Library/Dropbox/FileOperations/CreateFolder')
...
class CreateFolderInputSet(InputSet):
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(CreateFolderInputSet, self)._set_input('AccessTokenSecret', value)
    ...
    def set_AppKey(self, value):
        ...
        """
        super(CreateFolderInputSet, self)._set_input('AppKey', value)
    def set_AppSecret(self, value):
        ...
        """
        super(CreateFolderInputSet, self)._set_input('AppSecret', value)
    ...
    def set_ResponseFormat(self, value):
        ...
        """
        super(CreateFolderInputSet, self)._set_input('ResponseFormat', value)
    def set_Root(self, value):
        ...
        """
        super(CreateFolderInputSet, self)._set_input('Root', value)
