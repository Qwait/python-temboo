...
class InitializeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(InitializeOAuth, self).__init__(temboo_session, '/Library/Netflix/OAuth/InitializeOAuth')
...
class InitializeOAuthInputSet(InputSet):
    ...
    def set_SharedSecret(self, value):
        ...
        """
        super(InitializeOAuthInputSet, self)._set_input('SharedSecret', value)
