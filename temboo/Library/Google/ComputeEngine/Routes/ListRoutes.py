...
class ListRoutes(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Routes/ListRoutes')
    ...
    def _make_result_set(self, result, path):
        return ListRoutesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListRoutesChoreographyExecution(session, exec_id, path)

class ListRoutesInputSet(InputSet):
    """
...
class ListRoutesResultSet(ResultSet):
    """
...
class ListRoutesChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListRoutesResultSet(response, path)
