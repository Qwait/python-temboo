...
class InsertImage(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Images/InsertImage')
...
class InsertImageInputSet(InputSet):
    ...
    def set_ImageResource(self, value):
        ...
        """
        InputSet._set_input(self, 'ImageResource', value)
    ...
    def set_RawDiskSource(self, value):
        ...
        """
        InputSet._set_input(self, 'RawDiskSource', value)
