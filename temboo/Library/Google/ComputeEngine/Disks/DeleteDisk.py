...
class DeleteDisk(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Disks/DeleteDisk')
    ...
    def _make_result_set(self, result, path):
        return DeleteDiskResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteDiskChoreographyExecution(session, exec_id, path)

class DeleteDiskInputSet(InputSet):
    """
...
class DeleteDiskResultSet(ResultSet):
    """
...
class DeleteDiskChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteDiskResultSet(response, path)
