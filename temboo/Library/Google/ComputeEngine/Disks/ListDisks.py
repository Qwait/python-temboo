...
class ListDisks(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Disks/ListDisks')
    ...
    def _make_result_set(self, result, path):
        return ListDisksResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListDisksChoreographyExecution(session, exec_id, path)

class ListDisksInputSet(InputSet):
    """
...
class ListDisksResultSet(ResultSet):
    """
...
class ListDisksChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListDisksResultSet(response, path)
