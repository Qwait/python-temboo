...
class ListRegionOperations(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/RegionOperations/ListRegionOperations')
    ...
    def _make_result_set(self, result, path):
        return ListRegionOperationsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListRegionOperationsChoreographyExecution(session, exec_id, path)

class ListRegionOperationsInputSet(InputSet):
    """
...
class ListRegionOperationsResultSet(ResultSet):
    """
...
class ListRegionOperationsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListRegionOperationsResultSet(response, path)
