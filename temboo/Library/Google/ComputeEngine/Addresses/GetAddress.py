...
class GetAddress(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Addresses/GetAddress')
    ...
    def _make_result_set(self, result, path):
        return GetAddressResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetAddressChoreographyExecution(session, exec_id, path)

class GetAddressInputSet(InputSet):
    """
...
class GetAddressResultSet(ResultSet):
    """
...
class GetAddressChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetAddressResultSet(response, path)
