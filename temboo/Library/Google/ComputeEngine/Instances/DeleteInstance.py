...
class DeleteInstance(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Instances/DeleteInstance')
    ...
    def _make_result_set(self, result, path):
        return DeleteInstanceResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteInstanceChoreographyExecution(session, exec_id, path)

class DeleteInstanceInputSet(InputSet):
    """
...
class DeleteInstanceResultSet(ResultSet):
    """
...
class DeleteInstanceChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteInstanceResultSet(response, path)
