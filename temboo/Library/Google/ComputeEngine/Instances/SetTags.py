...
class SetTags(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Instances/SetTags')
...
class SetTagsInputSet(InputSet):
    ...
    def set_Fingerprint(self, value):
        ...
        """
        InputSet._set_input(self, 'Fingerprint', value)
    ...
    def set_Items(self, value):
        ...
        """
        InputSet._set_input(self, 'Items', value)
