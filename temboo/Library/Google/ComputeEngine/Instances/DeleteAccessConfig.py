...
class DeleteAccessConfig(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Instances/DeleteAccessConfig')
...
class DeleteAccessConfigResultSet(ResultSet):
    """
...
class DeleteAccessConfigChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteAccessConfigResultSet(response, path)
