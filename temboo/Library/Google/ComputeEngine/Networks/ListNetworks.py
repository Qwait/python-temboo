...
class ListNetworks(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Networks/ListNetworks')
    ...
    def _make_result_set(self, result, path):
        return ListNetworksResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListNetworksChoreographyExecution(session, exec_id, path)

class ListNetworksInputSet(InputSet):
    """
...
class ListNetworksResultSet(ResultSet):
    """
...
class ListNetworksChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListNetworksResultSet(response, path)
