...
class DeleteNetwork(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Networks/DeleteNetwork')
    ...
    def _make_result_set(self, result, path):
        return DeleteNetworkResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteNetworkChoreographyExecution(session, exec_id, path)

class DeleteNetworkInputSet(InputSet):
    """
    ...
    def set_Network(self, value):
        ...
        """
        InputSet._set_input(self, 'Network', value)
...
class DeleteNetworkResultSet(ResultSet):
    """
...
class DeleteNetworkChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteNetworkResultSet(response, path)
