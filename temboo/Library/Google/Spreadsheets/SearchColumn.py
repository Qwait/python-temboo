...
class SearchColumn(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/Spreadsheets/SearchColumn')
...
class SearchColumnInputSet(InputSet):
    ...
    def set_ReturnMatches(self, value):
        ...
        """
        InputSet._set_input(self, 'ReturnMatches', value)
    ...
    def set_SearchOperator(self, value):
        ...
        """
        InputSet._set_input(self, 'SearchOperator', value)
