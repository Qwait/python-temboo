...
class ListMonitoredTwitterHandles(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Zendesk/MonitoredTwitterHandles/ListMonitoredTwitterHandles')
    ...
    def _make_result_set(self, result, path):
        return ListMonitoredTwitterHandlesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListMonitoredTwitterHandlesChoreographyExecution(session, exec_id, path)

class ListMonitoredTwitterHandlesInputSet(InputSet):
    """
...
class ListMonitoredTwitterHandlesResultSet(ResultSet):
    """
...
class ListMonitoredTwitterHandlesChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListMonitoredTwitterHandlesResultSet(response, path)
