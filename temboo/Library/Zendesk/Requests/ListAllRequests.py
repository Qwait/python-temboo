...
class ListAllRequests(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Zendesk/Requests/ListAllRequests')
    ...
    def _make_result_set(self, result, path):
        return ListAllRequestsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListAllRequestsChoreographyExecution(session, exec_id, path)

class ListAllRequestsInputSet(InputSet):
    """
...
class ListAllRequestsResultSet(ResultSet):
    """
...
class ListAllRequestsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListAllRequestsResultSet(response, path)
