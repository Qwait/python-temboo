...
class ListActiveViews(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Zendesk/Views/ListActiveViews')
    ...
    def _make_result_set(self, result, path):
        return ListActiveViewsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListActiveViewsChoreographyExecution(session, exec_id, path)

class ListActiveViewsInputSet(InputSet):
    """
...
class ListActiveViewsResultSet(ResultSet):
    """
...
class ListActiveViewsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListActiveViewsResultSet(response, path)
