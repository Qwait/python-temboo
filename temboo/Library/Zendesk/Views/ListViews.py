...
class ListViews(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Zendesk/Views/ListViews')
    ...
    def _make_result_set(self, result, path):
        return ListViewsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListViewsChoreographyExecution(session, exec_id, path)

class ListViewsInputSet(InputSet):
    """
...
class ListViewsResultSet(ResultSet):
    """
...
class ListViewsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListViewsResultSet(response, path)
