...
class ReadPosts(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/General/Posts/ReadPosts')
    ...
    def _make_result_set(self, result, path):
        return ReadPostsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ReadPostsChoreographyExecution(session, exec_id, path)

class ReadPostsInputSet(InputSet):
    """
...
class ReadPostsResultSet(ResultSet):
    """
...
class ReadPostsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ReadPostsResultSet(response, path)
