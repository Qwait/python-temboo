...
class ReadWatch(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/Video/Watches/ReadWatch')
    ...
    def _make_result_set(self, result, path):
        return ReadWatchResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ReadWatchChoreographyExecution(session, exec_id, path)

class ReadWatchInputSet(InputSet):
    """
...
class ReadWatchResultSet(ResultSet):
    """
...
class ReadWatchChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ReadWatchResultSet(response, path)
