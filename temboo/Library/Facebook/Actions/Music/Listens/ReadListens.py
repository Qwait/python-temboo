...
class ReadListens(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/Music/Listens/ReadListens')
    ...
    def _make_result_set(self, result, path):
        return ReadListensResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ReadListensChoreographyExecution(session, exec_id, path)

class ReadListensInputSet(InputSet):
    """
...
class ReadListensResultSet(ResultSet):
    """
...
class ReadListensChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ReadListensResultSet(response, path)
