...
class CreateBike(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/Fitness/Bikes/CreateBike')
    ...
    def _make_result_set(self, result, path):
        return CreateBikeResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CreateBikeChoreographyExecution(session, exec_id, path)

class CreateBikeInputSet(InputSet):
    """
...
class CreateBikeResultSet(ResultSet):
    """
...
class CreateBikeChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return CreateBikeResultSet(response, path)
