...
class CreateReading(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/Books/Reads/CreateReading')
...
class CreateReadingInputSet(InputSet):
    ...
    def set_ProgressPercentComplete(self, value):
        ...
        """
        InputSet._set_input(self, 'ProgressPercentComplete', value)
    def set_ProgressTimestamp(self, value):
        ...
        """
        InputSet._set_input(self, 'ProgressTimestamp', value)
