...
class CreateQuote(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/Books/Quotes/CreateQuote')
    ...
    def _make_result_set(self, result, path):
        return CreateQuoteResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CreateQuoteChoreographyExecution(session, exec_id, path)

class CreateQuoteInputSet(InputSet):
    """
...
class CreateQuoteResultSet(ResultSet):
    """
...
class CreateQuoteChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return CreateQuoteResultSet(response, path)
