...
class Accounts(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Reading/Accounts')
    ...
    def _make_result_set(self, result, path):
        return AccountsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return AccountsChoreographyExecution(session, exec_id, path)

class AccountsInputSet(InputSet):
    """
...
class AccountsResultSet(ResultSet):
    """
...
class AccountsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return AccountsResultSet(response, path)
