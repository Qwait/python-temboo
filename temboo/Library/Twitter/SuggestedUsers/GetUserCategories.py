...
class GetUserCategories(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twitter/SuggestedUsers/GetUserCategories')
    ...
    def _make_result_set(self, result, path):
        return GetUserCategoriesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetUserCategoriesChoreographyExecution(session, exec_id, path)

class GetUserCategoriesInputSet(InputSet):
    """
...
class GetUserCategoriesResultSet(ResultSet):
    """
...
class GetUserCategoriesChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetUserCategoriesResultSet(response, path)
