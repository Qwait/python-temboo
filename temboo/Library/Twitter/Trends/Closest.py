...
class Closest(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twitter/Trends/Closest')
    ...
    def _make_result_set(self, result, path):
        return ClosestResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ClosestChoreographyExecution(session, exec_id, path)

class ClosestInputSet(InputSet):
    """
...
class ClosestResultSet(ResultSet):
    """
...
class ClosestChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ClosestResultSet(response, path)
