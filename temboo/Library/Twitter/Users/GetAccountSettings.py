...
class GetAccountSettings(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twitter/Users/GetAccountSettings')
    ...
    def _make_result_set(self, result, path):
        return GetAccountSettingsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetAccountSettingsChoreographyExecution(session, exec_id, path)

class GetAccountSettingsInputSet(InputSet):
    """
...
class GetAccountSettingsResultSet(ResultSet):
    """
...
class GetAccountSettingsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetAccountSettingsResultSet(response, path)
