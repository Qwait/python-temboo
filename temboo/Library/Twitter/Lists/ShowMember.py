...
class ShowMember(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twitter/Lists/ShowMember')
    ...
    def _make_result_set(self, result, path):
        return ShowMemberResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ShowMemberChoreographyExecution(session, exec_id, path)

class ShowMemberInputSet(InputSet):
    """
...
class ShowMemberResultSet(ResultSet):
    """
...
class ShowMemberChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ShowMemberResultSet(response, path)
