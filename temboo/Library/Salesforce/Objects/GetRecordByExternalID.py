...
class GetRecordByExternalID(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Salesforce/Objects/GetRecordByExternalID')
...
class GetRecordByExternalIDInputSet(InputSet):
    ...
    def set_FieldName(self, value):
        ...
        """
        InputSet._set_input(self, 'FieldName', value)
    def set_FieldValue(self, value):
        ...
        """
        InputSet._set_input(self, 'FieldValue', value)
