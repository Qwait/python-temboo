...
class InitializeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Salesforce/OAuth/InitializeOAuth')
...
class InitializeOAuthInputSet(InputSet):
    ...
    def set_Display(self, value):
        ...
        """
        InputSet._set_input(self, 'Display', value)
    ...
    def set_Immediate(self, value):
        ...
        """
        InputSet._set_input(self, 'Immediate', value)
