...
class LaunchArrayInstance(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(LaunchArrayInstance, self).__init__(temboo_session, '/Library/RightScale/LaunchArrayInstance')
...
class LaunchArrayInstanceInputSet(InputSet):
    ...
    def set_AccountID(self, value):
        ...
        """
        super(LaunchArrayInstanceInputSet, self)._set_input('AccountID', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) The RightScale account password.)
        """
        super(LaunchArrayInstanceInputSet, self)._set_input('Password', value)
    def set_ServerArrayID(self, value):
        ...
        """
        super(LaunchArrayInstanceInputSet, self)._set_input('ServerArrayID', value)
    def set_SubDomain(self, value):
        ...
        """
        super(LaunchArrayInstanceInputSet, self)._set_input('SubDomain', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) The RightScale username.)
        """
        super(LaunchArrayInstanceInputSet, self)._set_input('Username', value)
