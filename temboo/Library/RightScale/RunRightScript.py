...
class RunRightScript(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RunRightScript, self).__init__(temboo_session, '/Library/RightScale/RunRightScript')
...
class RunRightScriptInputSet(InputSet):
    ...
    def set_AccountID(self, value):
        ...
        """
        super(RunRightScriptInputSet, self)._set_input('AccountID', value)
    def set_Password(self, value):
        """
        Set the value of the Password input for this Choreo. ((required, password) The RightScale account password.)
        """
        super(RunRightScriptInputSet, self)._set_input('Password', value)
    def set_RightScriptID(self, value):
        ...
        """
        super(RunRightScriptInputSet, self)._set_input('RightScriptID', value)
    def set_ServerID(self, value):
        ...
        """
        super(RunRightScriptInputSet, self)._set_input('ServerID', value)
    def set_SubDomain(self, value):
        ...
        """
        super(RunRightScriptInputSet, self)._set_input('SubDomain', value)
    def set_Username(self, value):
        """
        Set the value of the Username input for this Choreo. ((required, string) The RightScale username.)
        """
        super(RunRightScriptInputSet, self)._set_input('Username', value)
